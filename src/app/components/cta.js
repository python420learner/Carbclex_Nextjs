        ...
        <>
            <div className='cta'>
                ...
                <div className='register'>
                    ...
                    <button onClick={handleClick} style={{ border: '2px solid white', color: 'white', borderRadius: '15px', padding: '0.7rem 3rem', backgroundColor: 'transparent', fontSize: '1.2rem', cursor: 'pointer' }}>REGISTER PROJECT</button>
                </div>
            </div>
        </>
    )
